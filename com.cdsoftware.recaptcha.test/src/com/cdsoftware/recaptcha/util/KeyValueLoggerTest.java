...
package com.cdsoftware.recaptcha.util;

import static com.cdsoftware.recaptcha.test.util.RandomTestUtil.*;
import static com.cdsoftware.recaptcha.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.recaptcha.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.recaptcha.util\"");
	}
